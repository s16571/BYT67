...
public class Money implements Comparable {
	...
	public Boolean equals(Money other) {
		return Objects.equals(other.amount, this.amount) && other.currency.equals(this.currency);
	}
	...
	public int compareTo(Object other) {
		var castedOther = (Money) other;
		var res = this.universalValue() - castedOther.universalValue();
		if (res > 0) {
			return 1;
		} else if (res < 0) {
			return -1;
